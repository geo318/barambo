  ...
  return (
    <div>
      <section className='pb-10'>
        ...
        <form action={createFile} className='p-5 m-10 border border-slate-400 shadow-md rounded-lg'>
          <input type='file' name='file' placeholder='upload file' className='border border-slate-500 rounded-md p-1 mr-5'/>
          <button type='submit' className='bg-blue-600 px-4 py-2 text-white rounded-md'>
            Upload
          </button>
        </form>
      </section>
